...
from productos.models import ProductoUsuario
from productos.serializer import UserProductoSerializer
...
def users_products(request):
    ...
    print ("t_PU", t_pu )
    serializer = UserProductoSerializer(instance= ProductoUsuario, many= True)
    return Response({"t_pu": serializer.data}, status=status.HTTP_200_OK)
